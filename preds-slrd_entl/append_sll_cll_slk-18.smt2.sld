...
LHS(next0,q,xprm,yprm,y,x) ::= xprm->yprm & next0=q & nil=q & xprm=x & yprm=y & y=x & nil!=x * ll(q)

RHS(next0,q,xprm,yprm,y,x) ::= next0=q & nil=q & xprm=x & yprm=y & y=x & nil!=x * clist(x) * ll(q)
