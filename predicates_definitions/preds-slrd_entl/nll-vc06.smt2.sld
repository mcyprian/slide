...
LHS(x1,x1_1,x1_2,x1_3,x2,x2_1,x2_2) ::= x1->x2,x1_1 * x1_1->x1_2 * x1_2->x1_3 * x1_3->nil * x2->nil,x2_1 * x2_1->x2_2 * x2_2->nil

RHS(x1,x1_1,x1_2,x1_3,x2,x2_1,x2_2) ::= nll(x1,x2,nil)
