Entail LHS(p,p1,q,q1,yprm,y,x,self,xprm,p2,q2) |- RHS(p,p1,q,q1,yprm,y,x,self,xprm,p2,q2)


LHS(p,p1,q,q1,yprm,y,x,self,xprm,p2,q2) ::= xprm->p2,q1 & p=p1 & q=self & nil!=q1 & x=xprm & yprm=y & nil!=x & self=xprm & p2=q2 * dll(q1,q)

RHS(p,p1,q,q1,yprm,y,x,self,xprm,p2,q2) ::= p=p1 & q=self & nil!=q1 & x=xprm & yprm=y & nil!=x & self=xprm & p2=q2 * dll_e3(x,q2)
