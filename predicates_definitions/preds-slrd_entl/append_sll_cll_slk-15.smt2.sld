Entail LHS(v1prm,q,xprm,y,x,yprm) |- RHS(v1prm,q,xprm,y,x,yprm)


LHS(v1prm,q,xprm,y,x,yprm) ::= xprm->q & v1prm=q & nil!=q & xprm=x & y=yprm & y=x & nil!=x * ll(q)

RHS(v1prm,q,xprm,y,x,yprm) ::= nil!=v1prm & v1prm=yprm * ll(v1prm)
