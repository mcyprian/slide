Entail LHS(v1prm,yprm,xprm,y,x,q1,self,p,p1,q) |- RHS(v1prm,yprm,xprm,y,x,q1,self,p,p1,q)


LHS(v1prm,yprm,xprm,y,x,q1,self,p,p1,q) ::= xprm->p1,q & v1prm=q & nil!=q & xprm=x & yprm=y & nil!=x & xprm=self & q1=p1 * dll(q,self) * dll(y,p)
